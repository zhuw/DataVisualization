var dashboard1 = (function () {
    ...
    function createMap(){
        ...
        if (!window['google']['loader'])
        {
            ...
            google.loader.ClientLocation = {"latitude":33.415,"longitude":-111.909,"address":{"city":"Tempe","region":"AZ","country":"USA","country_code":"US"}};
        ...
        drawChart();
        function drawChart() {
            alert("Loading the map, please do not check the prevent box...")
      ...
      data.addRows([
        ['"3021 N  Alma School Rd,Chandler, AZ 85224,United States"', 'China Way Restaurant',   'blue' ],
        ['"3208 E Cactus Road,Phoenix, AZ 85032,United States"',  'Queens Bowl Chinese Food',   'red'],
        ['"4929 W Chandler Blvd Ste 3,Chandler, AZ 85226,United States"',  'Chef Chiang', 'yellow' ],
        ['"2040 S Alma School Rd Ste 13,Chandler, AZ 85286,United States"',  'Beijing Restaurant', 'yellow' ],
        ['"302 E Flower St,Phoenix, AZ 85012,United States"',  'China Chili', 'red' ],
        ['"2710 E Indian School Rd,Phoenix, AZ 85016,United States"',  'China Village', 'yellow' ],
        ['"3215 E Indian School Rd,Phoenix, AZ 85018,United States"',  'Desert Jade', 'yellow' ],
        ['"1212 E Northern Ave,Phoenix, AZ 85020,United States"',  'Super Dragon', 'red' ],
        ['"10608 N 32nd St,Phoenix, AZ 85028,United States"',  'Little Peking', 'yellow' ],
        ['"13825 N 32nd St,Phoenix, AZ 85032,United States"',  'Dragon Palace', 'red' ],
        ['"1137 E Buckeye Rd,Phoenix, AZ 85034,United States"',  'Wongs Chinese Dining', 'red' ],
        ['"1602 S 7th Ave,Phoenix, AZ 85007,United States"',  'Liyuen', 'blue' ],
        ['"4730 E Warner Rd,Phoenix, AZ 85044,United States"',  'Panda Garden', 'yellow' ],
        ['"24 W Camelback Rd Ste H,Phoenix, AZ 85013,United States"',  'The Prime Chinese Restaurant', 'yellow' ],
        ['"1950 W Indian School Road,Phoenix, AZ 85015,United States"',  'Yins Chinese Resturant', 'blue' ],
        ['"8946 N 19th Ave,Phoenix, AZ 85021,United States"',  'Silver Dragon Chinese Restaurant', 'red' ],
        ['"6544 W Thomas Rd Ste 38,Phoenix, AZ 85033,United States"',  'Good China Restaurant', 'blue' ],
        ['"4231 W Bell Road,Phoenix, AZ 85053,United States"',  'New Asian Kitchen', 'yellow' ],
        ['"1739 W Glendale,Phoenix, AZ 85021,United States"',  'Dragon Chinese Restaurant', 'red' ],
        ['"1825 E Baseline Rd,Tempe, AZ 85283,United States"',  'Wongs Place', 'red' ],
        ['"2314 E Apache Blvd,Tempe, AZ 85281,United States"',  'Mius Cuisine', 'yellow' ],
        ['"219 E Baseline Rd Ste H-2,Tempe, AZ 85283,United States"',  'Beijing Express', 'red' ],
        ['"23623 N Scottsdale Rd,Scottsdale, AZ 85255,United States"',  'Jade Palace', 'yellow' ],
        ['"2640 W Baseline Rd,Mesa, AZ 85202,United States"',  'Golden Gate Chinese Restaurant', 'yellow' ],
        ['"832 W Baseline Rd,Mesa, AZ 85210,United States"',  'Golden Valley Chinese Restaurant', 'blue' ],
        ['"319 S Power Rd,Mesa, AZ 85206,United States"',  'China One', 'red' ],
        ['"66 S Dobson Rd Ste 127,Mesa, AZ 85202,United States"',  'Hengs Kitchen', 'yellow' ],
        ['"15768 N Frank Lloyd Wright Blvd,Scottsdale, AZ 85260,United States"',  'Fusion Sushi & China Bistro', 'yellow' ],
        ['"14870 N Northsight Blvd Ste 103,Scottsdale, AZ 85260,United States"',  'Asian Island', 'red' ],
        ['"13849 N 19th Ave,Phoenix, AZ 85023",United States',  'Golden Panda', 'yellow' ],
        ['"2540 S Val Vista Dr Ste 106,Gilbert, AZ 85296,United States"',  'J & K Gourmet', 'yellow' ],
        ['"6661 W Bell Rd Ste 101B,Glendale, AZ 85308,United States"',  'Stir Fry Paradise', 'blue' ],
        ['"3424 N 19th Ave,Phoenix, AZ 85015,United States"',  'Maxim Restaurant', 'red' ],
        ['"3076 E. Chandler Heights Rd Ste 104,Chandler, AZ 85249,United States"',  'Hong Kong Kitchen II', 'blue' ]
      ]);
      ...
      var options = {
        ...
        icons: {
          blue: {
            normal:   'http://icons.iconarchive.com/icons/double-j-design/origami-colored-pencil/48/blue-star-icon.png',
            selected:  './fonts/4.0stars.png'
          },
          red: {
            normal:   'http://icons.iconarchive.com/icons/double-j-design/origami-colored-pencil/48/red-star-icon.png',
            selected: './fonts/4.0stars.png'
          },
          yellow: {
            normal:   'http://icons.iconarchive.com/icons/double-j-design/origami-colored-pencil/48/yellow-star-icon.png',
            selected: './fonts/4.5stars.png'
          }
        },
    ...
    function render() {
        ...
        var html=
            '<h1 align="center">The Map of Chinese Restaurants (4 to 5 Stars)</h1>'+
            '<div id="map_div">' +
            '</div>'
